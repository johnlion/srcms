<?php /* Smarty version Smarty-3.1.18, created on 2015-10-20 17:03:49
         compiled from "application/views/admin/sys_user_group_list.html" */ ?>
<?php /*%%SmartyHeaderCode:211956568656260375233775-72485556%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '211956568656260375233775-72485556',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5626037544a053_28644780',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5626037544a053_28644780')) {function content_5626037544a053_28644780($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html lang="en">
<head>
...
<div class="page-header">
    ...
    <div class="row">
        <div class="col-xs-1"  style="min-width: 80px">
            <a href="/<?php echo @constant('ADMIN_THEME');?>
/sys_user_group/add" class="btn btn-success btn-sm">
...
<tr>
    ...
    <td>
        <div class="action-buttons">
            ...
            <a class="blue" href="/<?php echo @constant('ADMIN_THEME');?>
/sys_group_permission/config/?sys_group_id=<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
">
                <i class="ace-icon fa fa-cog bigger-130"></i>
            </a>

            <a class="green" href="/<?php echo @constant('ADMIN_THEME');?>
/sys_user_group/edit/?id=<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("inc_gritter.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '211956568656260375233775-72485556');
content_562603753b7068_54755905($_smarty_tpl);
...
<?php if ($_valid && !is_callable('content_562603753b7068_54755905')) {function content_562603753b7068_54755905($_smarty_tpl) {?><script>
